...
<head>
  ...
  <title>Vehicle Reservation - <?php include('../includes/title.php');?></title>
...
include('../includes/dbcon.php');
    $today=date("Y-m-d");
    $query=mysqli_query($con,"select * from reservation natural join menu where r_status='Approved' and r_date>='$today' order by r_date desc")or die(mysqli_error($con));
...
<?php
    ...
    $query1=mysqli_query($con,"select * from reservation natural join menu where menu_id='$id'")or die(mysqli_error($con));
