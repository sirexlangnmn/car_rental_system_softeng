...
<head>
  ...
  <title>Admin - <?php include('../includes/title.php');?></title>
...
<div class="navbar navbar-fixed-top bs-docs-nav" role="banner">
    ...
    <div class="conjtainer">
      ...
      <a href="index.html" class="navbar-brand hidden-lg">IT4E Car Rental Services</a>
    </div>
            ...
            <div class="col-md-12">
              ...
              <div class="widget">
                <div class="widget-head">
                  <div class="pull-left"> Admin
                    <a href="#addModal" class="btn btn-info" data-toggle="modal">Add New Admin</a>
                  </div>
            ...
            <div class="modal-body">
              ...
              <form class="form-horizontal" method="post" action="user_save.php">
                  ...
                  <div class="form-group">
                      <label class="control-label col-lg-2" for="username">Username</label>
                      <div class="col-lg-8"> 
                        <input type="text" class="form-control" name="username" value="admin_rex_pogi" placeholder="Write Username" required>
                      </div>
                  </div> 
                  <!-- Title -->
                  <div class="form-group">
