              ...
              <form class="form-horizontal" method="post" action="subcategory_update.php">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-lg-10"> 
                        ...
                        <input type="text" class="form-control" name="subcategory" id="title" placeholder="Category Name" value="<?php echo $name;?>">
                      </div>
                  </div> 
            ...
            <div class="modal-body">
              ...
              <form class="form-horizontal" method="post" action="subcategory_save.php">
                  ...
                  <div class="form-group">
                      <label class="control-label col-lg-2" for="title">Category Name</label>
                      <div class="col-lg-8"> 
                        <input type="text" class="form-control" name="subcategory" id="title" placeholder="Category Name" required>
                      </div>
                  </div> 
