...
include('../includes/dbcon.php');
    ...
    $query=mysqli_query($con,"select * from reservation left join member on reservation.member_id=member.member_id where r_status='Pending'")or die(mysqli_error($con));
...
?>                      
                      <tr>
                        ...
                        <td>
                              <a rel="tooltip"  data-placement="bottom" title="Payment" id="Payment"
							  href="#payment" class="btn btn-default" data-target="#payment<?php echo $id;?>" data-toggle="modal">
            ...
            <div class="modal-body">
              ...
              <form class="form-horizontal" method="post" action="menu_save.php" enctype='multipart/form-data'>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-lg-8"> 
                        <input type="text" class="form-control" name="Rent Price" id="title" placeholder="Price">
                      </div>
                  </div> 
                  <!-- Title -->
                  <div class="form-group">
