...
<head>
  ...
  <title>Confirmed Reservation - <?php include('../includes/title.php');?></title>
...
<div class="content" style="margin-top:10px">
	...
	<div id="legend">
<align = "center">
	<h4><u>Button Legend</u></h4>
	
	Payment : &nbsp; <img src="../img/button/payment.png">&nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp; 
	View Details : &nbsp; <img src="../img/button/view.png">&nbsp;  &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp;  &nbsp; 	
	Modify Details : &nbsp; <img src="../img/button/edit.png">&nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp;  &nbsp;  &nbsp; 
	Assign Driver : &nbsp; <img src="../img/button/assigned.png"></p>&nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; &nbsp; 
	</center>
	</div>
</div>
                <!-- Table -->
...
include('../includes/dbcon.php');
    ...
    $query=mysqli_query($con,"select * from reservation left join member on reservation.member_id=member.member_id where r_status='Approved'")or die(mysqli_error($con));
...
?>                      
                      <tr>
                        ...
                        <td>
                              <a rel="tooltip" data-placement="bottom" title="Payment" id="Payment" href="#payment" class="btn btn-default" data-target="#payment<?php echo $id;?>" data-toggle="modal">
                                <i class="fa fa-money bgreen"></i>
                              </a>
                              <a rel="tooltip" data-placement="bottom" title="View Reservation Detail" id="View Reservation Detail" href="reservation_view.php?id=<?php echo $id;?>" class="btn btn-success">
                                <i class="fa fa-eye"></i>
                              </a>
                              <a rel="tooltip" data-placement="bottom" title="Update Customer Detail" id="Update Customer Details" href="#update" class="btn btn-info" data-target="#update<?php echo $id;?>" data-toggle="modal">
                                <i class="fa fa-pencil"></i>
                              </a>
                              <a rel="tooltip" data-placement="bottom" title="Assign Driver" id="Assign Driver" href="#assign" class="btn btn-info" data-target="#assign<?php echo $id;?>" data-toggle="modal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="height:120px">
              ...
              <form class="form-horizontal" method="post" action="assign_save.php" enctype='multipart/form-data'>
                  ...
                  <!-- Title -->
                  <div class="form-group">
                      <label class="control-label col-lg-4" for="title">Driver</label>
                      <div class="col-lg-8"> 
                        <select class="form-control select2" id="exampleSelect1" name="member">
                         <?php
               include('../includes/dbcon.php'); //bagong lagay //
