        ...
        <div class="modal-header">
         ...
         <div class="modal-body">
                  ...
                  <form class="form-horizontal">	
					...
					<div class="form-group">
                      <label class="control-label col-lg-3" for="inputPassword">Contact Number</label>
                      <div class="col-lg-7">
                        <input type="text" name = "home_address" class="form-control" id="inputPassword" placeholder="Contact Number">
                      </div>
                    </div>
					...
					<hr/>
					<div class="form-group">
                      <label class="control-label col-lg-3" for="inputPassword">Purpose of Renting</label>
                      <div class="col-lg-7">
                         <input class="form-control" rows="3" placeholder="Purpose"></textarea>
                      </div>
                    </div>
					<div class="form-group">
                      <label class="control-label col-lg-3" for="inputPassword">Pick Up Date</label>
                      <div class="col-lg-3">
					...
					<div class="form-group">
                      <label class="control-label col-lg-3" for="inputPassword">Suggested Car Color</label>
                      <div class="col-lg-7">
					...
					<div class="form-group">
                      <label class="control-label col-lg-3" for="inputPassword">Destination</label>
                      <div class="col-lg-7">
						<select name = "theme" class = "form-control">					
							<option></option>							
							<option></option>							
